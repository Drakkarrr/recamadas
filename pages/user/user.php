                                    ...
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            while($row = mysqli_fetch_array($squery))
                                            {
                                                echo '
                                                <tr>
                                                    <td><input type="checkbox" name="chk_delete[]" class="chk_delete" value="'.$row['id'].'" /></td><td style="text-align: center;">
                                                        <img src="uploads/'.$row['photo'].'" alt="Photo" style="width:80px;height:80px;" />
                                                    </td>
                                                    <td>'.$row['name'].'</td>
                                                    <td>'.$row['username'].'</td>
                                                    <td>'.$row['password'].'</td>
